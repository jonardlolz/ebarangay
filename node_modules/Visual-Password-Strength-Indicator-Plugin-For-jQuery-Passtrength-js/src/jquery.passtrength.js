  ...
  Plugin.prototype = {
    ...
    togglePassword: function(){
      var buttonShow = jQuery("<span/>", {class: "showPassword", html: "<img src="+ this.options.eyeImg +" />"}),
        input = jQuery("<input class='form-control form-control-user' placeholder='Password'/>", {type: "text"}),
          passwordInput      = this;
      ...
      $(document).on("click", ".showPassword", function() {
        ...
        $(passwordInput.element).get(0).type = (buttonShow.hasClass("active") ? 'text' : 'password');
      });
    }
  };
